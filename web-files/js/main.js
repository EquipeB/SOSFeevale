...
jQuery(document).ready(function($){
	...
	{
		//google map
		var coordinate = new google.maps.LatLng(-29.6857629, -51.1315748);
		var mapOptions = {
			zoom: 15,
			center: coordinate,
		...
		new google.maps.Marker({
			position: new google.maps.LatLng(-29.6857629, -51.1315748),
			map: map,
			icon: new google.maps.MarkerImage("../web-files/img/map_pointer.png", new google.maps.Size(29, 38), null, new google.maps.Point(14, 37))
		});
	}
...
function abrirModal(id){
	if($('#modal').hasClass('ativo')){
		$('#modal').fadeOut().removeClass('ativo');
		$('#modal').find('input[name="id"]').val('');
	}else{
		$('#modal').fadeIn().addClass('ativo');
